...
guiElements.mainFrame = createUIElement("Frame", {
    Name = "MainFrame",
    Size = UDim2.new(0, 300, 0, 300), -- Ajustar altura
...
guiElements.laggerSection = createUIElement("Frame", {
    Name = "LaggerSection",
    Size = UDim2.new(1, 0, 0.5, 0), -- Ajustar tamanho para acomodar Anti-Lag
...
guiElements.antiLagSection = createUIElement("Frame", {
    Name = "AntiLagSection",
    Size = UDim2.new(1, 0, 0.3, 0), -- Ajustar tamanho
    Position = UDim2.new(0, 0, 0.5, 0), -- Posicionar abaixo da seção Lagger
    BackgroundColor3 = Color3.fromRGB(50, 50, 50),
    BackgroundTransparency = 0.1,
    BorderSizePixel = 0
}, guiElements.contentFrame)
